...
int main(void)
{
    ...
    char e_right_back = 0;
    char e_right_front = 0;
    char e_left_back = 0;
    char e_left_front = 0;
    char distance_front = 0;
    char distance_driven = 0;
    char alpha_left = 0;
    char alpha_right = 0;
    char sign_alpha_left = 0;
    char sign_alpha_right = 0;
    ...
    for (;;)
    {
        ...
        {
            PORTA = fetch_from_buffer(&receive_buffer).type;
            ...
            switch (temp_char)
            {
                ...
                case 0xF6:  // alpha measured from right:
                    alpha_right = fetch_from_buffer(&receive_buffer).val;
                    discard_from_buffer(&receive_buffer);
                    break;
                    
                case 0xF5:  // alpha measured from left
                    alpha_left = fetch_from_buffer(&receive_buffer).val;
                    discard_from_buffer(&receive_buffer);
                    break;
        ...
        e = round((20 - (e_right_back + e_right_front)/2)/2 + ((e_left_back + e_left_front)/2 - 20)/2);
        _delay_ms(0.5);
        
        //sets alpha
        /*	//sets alpha
         if (e_right_back || e_right_front > 30 * 5) // When one of the right hand side sensors can't see a wall alpha i calculated from the left hand side sensors
         {
         ...
         else if (e_left_back || e_left_front > 30 * 5) // When one of the left hand side sensors can't see a wall alpha i calculated from the right hand side sensors
         {
